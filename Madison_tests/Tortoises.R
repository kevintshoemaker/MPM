...
#TT <- seq(8,20,1)
#varimature <- seq(0,25) #variability in maturation, (0,coefficient of variation or CV aka 
                        #fraction of the mean to get to stddev)
                        #age of maturation and fecundity driven by latitude (so temperature)
                        #Use two standards deviations away from mean as min using coefficient 
                        #of variation
